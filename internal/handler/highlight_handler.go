...
func (h *HighlightHandler) Update(c *gin.Context) {
	userID, ok := authUser(c); if !ok { return }
	highlightID, ok := parseHighlightID(c); if !ok { return }
	var req dto.UpdateHighlightRequest
	if err := c.ShouldBindJSON(&req); err != nil { response.BadRequest(c, "Invalid request body"); return }
	if h.handleError(c, h.service.Update(userID, highlightID, req)) { return }
...
func (h *HighlightHandler) Delete(c *gin.Context) {
	userID, ok := authUser(c); if !ok { return }
	highlightID, ok := parseHighlightID(c); if !ok { return }
	if h.handleError(c, h.service.Delete(userID, highlightID)) { return }
...
func (h *HighlightHandler) AddStory(c *gin.Context) {
	...
	if err := c.ShouldBindJSON(&req); err != nil { response.BadRequest(c, "Invalid request body"); return }
	if h.handleError(c, h.service.AddStory(userID, highlightID, req)) { return }
...
func (h *HighlightHandler) RemoveStory(c *gin.Context) {
	...
	if h.handleError(c, h.service.RemoveStory(userID, highlightID, storyID)) { return }
...
func parseHighlightID(c *gin.Context) (uuid.UUID, bool) {
	...
	if err != nil { response.BadRequest(c, "Invalid highlight id"); return uuid.Nil, false }
	return id, true
}
